        ...
        methods: {
            ...
            async searchList(){
              try{
                ...
                console.log("TCL: searchList -> shopgroupList", shopgroupList)
                let shopList = await finance_shopList()
                console.log("TCL: searchList -> shopList", shopList)
                console.log("TCL: searchList -> data", data)
            ...
            async getApiDataList(){
                ...
                // if(!newObj.platform){
                //   return this.$message.error("请选择平台数据")
                // }
                ...
                //   return this.$message.error("请选择发货时间,退款时间,订单时间中的一个")
                // }
